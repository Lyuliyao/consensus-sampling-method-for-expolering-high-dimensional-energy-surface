...
def generate_plumed_file(id):
    ...
    ene: ENERGY
    ADACHANGE_F6 ARG=ome1,phi1,psi1,ome2,phi2,psi2,ome3,phi3,psi3 N_ESAMBLE=64 KAPPA=500.0,500.0,500.0,500.0,500.0,500.0,500.0,500.0,500.0   LABEL=restraint  BETA=1 ET=5000 FDT=50000 EPSILON=1 ALPHA=0.1 GAMMA=1 CPT=5000 BP=../model_save/potential{}.jlt DR=1.0 SB=0.0 BETAA=100 AT_FILE=../AT.txt
    """.format(id-1),file=f)
