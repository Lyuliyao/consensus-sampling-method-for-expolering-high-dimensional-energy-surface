...
class Potential(torch.nn.Module):
    def __init__(self,N_in,N_w):
        ...
        self.W1 = torch.nn.Parameter(torch.randn(N_w,N_in)/10)
        self.b1 = torch.nn.Parameter(torch.randn(N_w,1)/10)
        self.W2 = torch.nn.Parameter(torch.randn(N_w,N_w)/10)
        self.b2 = torch.nn.Parameter(torch.randn(N_w,1)/10) 
        self.W3 = torch.nn.Parameter(torch.randn(N_w,N_w)/10)
        self.b3 = torch.nn.Parameter(torch.randn(N_w,1)/10)  
        self.W4 = torch.nn.Parameter(torch.randn(1,N_w)/10)
        self.b4 = torch.nn.Parameter(torch.randn(1,1)/10)
